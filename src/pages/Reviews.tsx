            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              ...
              <div className="bg-white rounded-xl shadow-elegant p-6 animate-fade-in">
                ...
                <div className="relative w-full" style={{ minHeight: "600px" }}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3322.5!2d-117.7845!3d33.6599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dcde0a3e3e3e3e%3A0x1234567890abcdef!2sFebe%20Coffee!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus&q=13955+Yale+Ave+Unit+A,+Irvine,+CA+92620"
                    width="100%"
                    height="600"
                    ...
                    title="Febe Coffee Google Reviews"
                  />
                </div>
                <div className="mt-6 text-center">
                  <a
                    href="https://www.google.com/maps/place/Febe+Coffee/@33.6599,-117.7845,17z/data=!3m1!4b1!4m6!3m5!1s0x0:0x0!8m2!3d33.6599!4d-117.7845"
                    target="_blank"
              ...
              <div className="bg-white rounded-xl shadow-elegant p-6 animate-fade-in" style={{ animationDelay: "200ms" }}>
                ...
                <div className="relative w-full" style={{ minHeight: "600px" }}>
                  <iframe
                    src="https://www.yelp.com/embed/business/febe-coffee-irvine-3"
                    width="100%"
                    height="600"
                    style={{ border: 0, borderRadius: "8px" }}
                    allowFullScreen
